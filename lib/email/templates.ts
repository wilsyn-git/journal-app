...
export function welcomeEmail(name: string) {
    ...
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
        <h1>Welcome to myJournal, ${name}!</h1>
    ...
    `;
    return {
        subject: "Welcome to myJournal",
        html,
        text: `Welcome to myJournal, ${name}! We're excited to have you on board. Log in at ${process.env.NEXT_PUBLIC_APP_URL}`
    };
}
...
export function passwordResetEmail(resetUrl: string) {
    ...
    `;
    return {
        subject: "Reset your myJournal Password",
        html,
