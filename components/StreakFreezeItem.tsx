...
export function StreakFreezeItem({ freezeCount, maxQuantity, earningCounter, earningInterval, usageHistory }: Props) {
            ...
            <div className="flex items-center gap-3 p-4">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-baseline gap-3">
                        <span className="font-bold text-white">Streak Freezes</span>
                        {lastUsed && (
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                    <div className="flex items-baseline gap-0.5">
                        <span className="text-2xl font-bold text-sky-400">{freezeCount}</span>
